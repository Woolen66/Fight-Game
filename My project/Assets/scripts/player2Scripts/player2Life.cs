...
public class player2Life : CharacterLife
{
    ...
    {
        currentLife -= damage;
        player1Data.stats.total_damage += damage;

        if (currentLife <= 0)
        {
            winObject.GetComponent<win>().FinishGame("Player1");
            player1Data.stats.wins += 1;
            player2Data.stats.losses += 1;
